...
{
   public class JuegoColaCircular
    {
        ...
        {
            Console.Title = "Culebrita con COLA CIRCULAR";
        ...
        private static bool MoverLaCulebrita(Cola_Circular culebra, Point posiciónObjetivo,
            ...
            
        {
            ...
            // Quitar cola
            if (culebra.cantidadElementos() > longitudCulebra)
            {
        ...
        private static Point MostrarComida(Size screenSize, Cola_Circular culebra)
        {
            var lugarComida = Point.Empty;
            var cabezaCulebra = (Point)culebra.finalCola();
            var cX = cabezaCulebra.X;
            var cY = cabezaCulebra.Y;
            ...
            do
            {
                ...
                if (culebra.ToString().All(x => cY != x || cY != y)
        ...
        public void jugar() {
            ...
            var culebrita = new Cola_Circular();
