...
namespace culebrita.Culebrita
{
    class JuegoColaLineal
    {
        ...
        private static bool MoverLaCulebrita(Cola_Lineal culebra, Point posiciónObjetivo,
        ...
        private static Point MostrarComida(Size screenSize, Cola_Lineal culebra)
        {
